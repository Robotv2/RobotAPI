package fr.robotv2.robotapi.holo;

import fr.robotv2.robotapi.entity.EntityPersistor;
...
public class Hologram {
    ...
    public static Hologram getAt(Location loc) {
        ...
        return new Hologram(id, stands.get(0).getLocation(), stands);
    }

    private final int id;
    private final List<EntityPersistor<ArmorStand>> stands = new ArrayList<>();
